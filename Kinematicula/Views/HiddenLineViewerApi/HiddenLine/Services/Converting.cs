namespace Kinematicula.Views.HiddenLineViewerApi.HiddenLine.Services;
...
public static class Converting
{
    ...
    private static IEnumerable<EdgeHL> ConvertToEdgeHL(this Body body, Dictionary<Triangle, TriangleHL> dict, Matrix44D cameraFrame)
    {
        ...
        var edgesHL = body.Edges.Select(edge => ConvertToEdgeHL(edge, body, dict, cameraAndBodyFrame));
        return edgesHL;
    }

    private static EdgeHL ConvertToEdgeHL(Edge edge, Body body, Dictionary<Triangle, TriangleHL> dict, Matrix44D cameraAndBodyFrame)
    {
