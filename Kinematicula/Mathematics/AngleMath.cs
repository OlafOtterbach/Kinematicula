...
namespace Kinematicula.Mathematics
{
    public static class AngleMath
    {
        ...
        public static double DegToRad(this double degAngle)
        {
            var result = degAngle * Math.PI / 180.0f;
            return result;
        }

        public static double DegToRad(this int degAngle)
        {
            return DegToRad((double)degAngle);
        }

        public static double RadToDeg(this double radAngle)
        {
            var result = radAngle * 180.0f / Math.PI;
            return result;
        }

        public static double RadToDeg(this int radAlpha)
        {
            return RadToDeg((double)radAlpha);
        }
