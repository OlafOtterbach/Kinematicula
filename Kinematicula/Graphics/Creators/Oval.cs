...
namespace Kinematicula.Graphics.Creators
{
    public static class Oval
    {
            ...
            Matrix44D originFrame)
        {
            ...
            var (topLoop1, topLoop2) = CreateTopBottomFace(segments1, segments2, radius1, radius2, length, depth, depth/2.0, creator, true);
            var (bottomLoop1, bottomLoop2) = CreateTopBottomFace(segments1, segments2, radius1, radius2, length, depth, -depth / 2.0, creator, false);
