...
namespace Kinematicula.Tests.Mathematics
{
    ...
    public class Vector3DTests
    {
        ...
        {
            Assert.Equal(0.0, new Vector3D(1, 0, 0) * new Vector3D(0, 1, 0), 2);
            Assert.Equal(0.0, new Vector3D(1, 0, 0) * new Vector3D(0, 0, 1));
            Assert.Equal(0.0, new Vector3D(0, 1, 0) * new Vector3D(0, 0, 1));
            Assert.Equal(0.0, new Vector3D(0, 1, 0) * new Vector3D(1, 0, 0));
            Assert.Equal(0.0, new Vector3D(0, 0, 1) * new Vector3D(1, 0, 0));
            Assert.Equal(0.0, new Vector3D(0, 0, 1) * new Vector3D(0, 1, 0));
            Assert.NotEqual(0.0, new Vector3D(1, 0, 1) * new Vector3D(1, 1, 0));
        }
